      ...
      <el-card style="margin-top: 10px;">
        <el-table border :data="employeesList" stripe>
          ...
          <el-table-column label="操作" width="280">
            <template v-slot="{ row }">
              <el-button type="success" size="small" @click="lookDailFn(row.id,row.formOfEmployment)">查看</el-button>
              <el-button type="primary" size="small" @click="RoleDialog(row.id)">分配角色</el-button>
              <el-button type="danger" size="small" @click="delEmp(row.id)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
        <!-- 分页组件 -->
...
export default {
  ...
  methods: {
    ...
    lookDailFn(empid, empformOfEmployment) {
      // console.log('empid, empformOfEmployment', empid, empformOfEmployment)
    ...
    async addRoleFn(val) {
      ...
      console.log('click_RoleID', this.click_RoleID)
      console.log('this.Role_powerList', this.Role_powerList)
      // console.log('this.Role_powerList', typeof (this.Role_powerList))
